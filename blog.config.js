...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '开淳的笔记本', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普普通通的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.kaichun.asia', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'KaiChun, 博客', // 网站关键词 英文逗号隔开
